...
public class PackageBuilder : IPackageBuilder
{
    ...
    private List<DocumentFile> CreateDocumentation(Manifest manifest)
    {
        ...
        exportInfo.AppendLine("HotelDroid Export Package");
        ...
        importGuide.AppendLine("3. Use the Import functionality in HotelDroid.API");
        ...
        importGuide.AppendLine("  - Legacy HotelDroid instances can still import with mapping");
