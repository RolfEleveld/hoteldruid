...
namespace HotelDruid.Api.Tests.Integration.ExportImport;
...
public class ExportImportIntegrationTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task ExportFormatCompatibility_WithHotelDruidNames()
    {
        // Arrange - simulate export from HotelDruid with Italian names
