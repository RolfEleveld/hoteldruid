...
namespace HotelDruid.Api.Tests.Unit.ExportImport;
...
public class CanonicalMapperTests
{
    ...
    [Fact]
    public void GetHotelDruidTableName_ReturnsCompatibilityName()
    {
        // Act
        var result = _mapper.GetHotelDruidTableName("rooms");
