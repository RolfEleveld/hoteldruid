...
$soldi_prenota_cancellate = (double) risul_query($soldi_prenota_cancellate,0,'soldi_prima');
...
$d_costo_tariffa = (double) fixset($d_tariffa[1]);
...
if (strcmp(fixstr($n_sconto[1]),"")) $n_caparra = (double) $n_sconto[1];
else $n_caparra = "";
if (strcmp(fixstr($n_sconto[2]),"")) $n_commissioni = (double) $n_sconto[2];
else $n_commissioni = "";
...
$soldi_prenota_cancellate = esegui_query("select soldi_prima from $tablesoldi where idsoldi = 1");
$soldi_prenota_cancellate = (double) risul_query($soldi_prenota_cancellate,0,'soldi_prima');
$soldi_prenota_cancellate = $soldi_prenota_cancellate + (double) $saldo;
esegui_query("update $tablesoldi set soldi_prima = '$soldi_prenota_cancellate' where idsoldi = 1");
} # fine if ($pcanc)
unlock_tabelle($tabelle_lock);
