...
if ($azione[3] == "*") $var_da_assegnare = (double) $var_da_oper * (double) $var_da_oper2;
if ($azione[3] == "/") {
if ((double) $var_da_oper2 != (double) 0) $var_da_assegnare = (double) $var_da_oper / (double) $var_da_oper2;
else $var_da_assegnare = (double) $var_da_oper / 0.01;
} # fine if ($azione[3] == "/")
if ($azione[6]) {
...
calcola_tasse_contr(((double) $costo_tariffa - (double) $sconto),$percentuale_tasse_tariffa,$arrotond_tasse,$tasse_sconto,$tasse_sconto_p,$sconto_senza_tasse,$sconto_senza_tasse_p,$stile_soldi);
