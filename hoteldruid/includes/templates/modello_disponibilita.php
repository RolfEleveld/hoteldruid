...
$num_aggiungi_letti = ceil((double) $posti_mancanti[$n_t] / (double) $num_app_tipo_richiesti);
...
$costo_tariffap_settimana_alt = (double) $costo_tariffap_sett * (double) $numpersone_nr[$n_t][$num2];
