...
if ($nome_mese == "Jan") $nome_mese = mex("Gen",'giorni_mesi.php');
if ($nome_mese == "Feb") $nome_mese = mex("Feb",'giorni_mesi.php');
if ($nome_mese == "Mar") $nome_mese = mex("Mar",'giorni_mesi.php');
if ($nome_mese == "Apr") $nome_mese = mex("Apr",'giorni_mesi.php');
if ($nome_mese == "May") $nome_mese = mex("Mag",'giorni_mesi.php');
if ($nome_mese == "Jun") $nome_mese = mex("Giu",'giorni_mesi.php');
if ($nome_mese == "Jul") $nome_mese = mex("Lug",'giorni_mesi.php');
if ($nome_mese == "Aug") $nome_mese = mex("Ago",'giorni_mesi.php');
if ($nome_mese == "Sep") $nome_mese = mex("Set",'giorni_mesi.php');
if ($nome_mese == "Oct") $nome_mese = mex("Ott",'giorni_mesi.php');
if ($nome_mese == "Nov") $nome_mese = mex("Nov",'giorni_mesi.php');
if ($nome_mese == "Dec") $nome_mese = mex("Dic",'giorni_mesi.php');
if (!$date_option) {
...
if ($numero_mese == "01") $nome_mese = mex("Gen",'giorni_mesi.php');
if ($numero_mese == "02") $nome_mese = mex("Feb",'giorni_mesi.php');
if ($numero_mese == "03") $nome_mese = mex("Mar",'giorni_mesi.php');
if ($numero_mese == "04") $nome_mese = mex("Apr",'giorni_mesi.php');
if ($numero_mese == "05") $nome_mese = mex("Mag",'giorni_mesi.php');
if ($numero_mese == "06") $nome_mese = mex("Giu",'giorni_mesi.php');
if ($numero_mese == "07") $nome_mese = mex("Lug",'giorni_mesi.php');
if ($numero_mese == "08") $nome_mese = mex("Ago",'giorni_mesi.php');
if ($numero_mese == "09") $nome_mese = mex("Set",'giorni_mesi.php');
if ($numero_mese == "10") $nome_mese = mex("Ott",'giorni_mesi.php');
if ($numero_mese == "11") $nome_mese = mex("Nov",'giorni_mesi.php');
if ($numero_mese == "12") $nome_mese = mex("Dic",'giorni_mesi.php');
$n_date_menu++;
...
$id_data_ini_periodi_prec = 0;
$id_data_fine_periodi_prec = 0;
...
$agg_mess = 1;
$n_lista_pren = "";
$lista_pren = explode(",",(string) risul_query($messaggi_importati,$num1,'dati_messaggio1'));
...
} # fine if ($id_data_fine_pp >= $id_data_ini_periodi_prec and $id_data_inizio_pp <= $id_data_fine_periodi_prec)
...
flock($filelock,3);
fclose($filelock);
if (is_file(C_DATI_PATH."/anni.lock")) unlink(C_DATI_PATH."/anni.lock");
} # fine if ($filelock)
