...
$importa_fisso = (double) $dati_tariffe[$tariffa]['val_importa'][$num_ord];
$importa_percent = (double) $dati_tariffe[$tariffa]['perc_importa'][$num_ord];
...
$resto_int = $importa_fisso - (double) $agg_int;
