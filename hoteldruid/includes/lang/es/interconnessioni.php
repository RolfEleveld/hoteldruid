...
case "Con la subordinazione non si potranno inserire nuovi dati o apportare modifiche, ma solo importare i dati dall'installazione principale":	$messaggio = "Con la subordinación no se podrán ingresar nuevos datos y efectuar modificaciones, solo importar datos desde la instalación principal"; break;
