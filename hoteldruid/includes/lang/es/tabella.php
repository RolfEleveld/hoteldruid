...
case "Prenotazione confermata, caparra non pagata":	$messaggio = "Reserva confirmada, depósito no pagado"; break;
case "Caparra pagata":  			$messaggio = "Depósito pagado"; break;
case "Tutto pagato":  				$messaggio = "Todo pagado"; break;
case "durante l'inserimento dei dati del cliente quando si inserisce una nuova prenotazione":	$messaggio = "durante el ingreso de los datos del cliente cuando se ingresa una nueva reserva"; break;
case "Utilizzando il tasto 'cancella' dalla pagina di inserimento dei dati del cliente anche questa prenotazione verà cancellata":	$messaggio = "Al utilizar el botón 'cancelar' en la página de ingreso de los datos del cliente, esta reserva también será cancelada"; break;
