...
case "Eccezione alla regola 2 per periodo limitato": $messaggio = "Excepción a la regla 2 por período limitado"; break;
case "Tariffa": $messaggio = "Tarifa"; break;
case "mostra tabella": $messaggio = "mostrar tabla"; break;
case "nascondi tabella": $messaggio = "ocultar tabla"; break;
case "variabile": $messaggio = "variable"; break;
case "da assegnare per ogni prenotazione": $messaggio = "a asignar por cada reserva"; break;
case "Inserisci o modifica l'eccezione alla regola": $messaggio = "Ingresar o modificar la excepción a la regla"; break;
case "Numero di giorni": $messaggio = "Número de días"; break;
case "dall'inizio o dalla fine del periodo": $messaggio = "del principio o del final del período"; break;
case "Azione": $messaggio = "Acción"; break;
case "Periodo dal": $messaggio = "Período desde"; break;
case "Motivazione": $messaggio = "Motivación"; break;
case "Assegna a utente": $messaggio = "Asignar a usuario"; break;
case "sceglie questa tariffa, fai risultare come se l'utente selezionato avesse inserito la prenotazione e l'eventuale cliente": $messaggio = "escoge esta tarifa, haz resultar como si el usuario seleccionado hubiese insertado la reserva y el eventual cliente"; break;
case "Numero di persone": $messaggio = "Número de personas"; break;
case "Minimo persone": $messaggio = "Mínimo personas"; break;
case "Inserimento rapido costo aggiuntivo": $messaggio = "Ingreso rápido costo adicional"; break;
