...
case "Inserisci le regole di assegnazione per le prenotazioni dell'anno":	$messaggio = "Ingresar las reglas de asignación para las reservas del año"; break;
...
case "Inserisci la regola":  			$messaggio = "Ingresar la regla"; break;
case "Inserisci o modifica la regola":  	$messaggio = "Ingresar o modificar la regla"; break;
...
case "Vedi le regole già inserite":  		$messaggio = "Mirar las reglas ya guardados"; break;
case "Torna al menù principale":  		$messaggio = "Volver al menú principal"; break;
case "Non sono stati inseriti tutti i dati necessari":	$messaggio = "No han sido guardados todos los datos necesarios"; break;
...
case "Sei sicuro di voler cancellare tutte le regole del tipo 1":	$messaggio = "Estás seguro de que qeieres eliminar todas las reglas de tipo 1"; break;
case "SI":  					$messaggio = "SI"; break;
case "Le regole sono state cancellate":  	$messaggio = "Las reglas han sido borradas"; break;
case "Si deve scegliere la tariffa":  		$messaggio = "Debe escoger la tarifa"; break;
...
case "La tariffa scelta ha già un utente associato, cancella la regola prima di inserirne una nuova":	$messaggio = "La tarifa escogida ya tiene un usuario asociado, elimina la regla antes de ingresar una nueva"; break;
...
case "Si deve inserire l'utente da associare":	$messaggio = "Debe ingresar el usuario a asociar"; break;
...
case "La tariffa scelta ha già un numero di persone associato, cancella la regola prima di inserirne una nuova":	$messaggio = "La tarifa escogida ya tiene número de personas asociado, elimina la regla antes de ingresar una nueva"; break;
case "Si deve inserire il numero di persone da associare":	$messaggio = "Debe ingresar el número de personas a asociar"; break;
...
case "Inserisci o modifica questa eccezione alla regola":	$messaggio = "Ingresar o modificar esta excepción a la regla"; break;
case "Si deve inserire il numero di giorni":  	$messaggio = "Debe ingresar el número de dias"; break;
...
case "Cancella o ridimensiona queste regole":  	$messaggio = "Eliminar o reducir estas reglas"; break;
case "Cancella":  				$messaggio = "Eliminar"; break;
...
case "non permettere l'inserimento di prenotazioni con meno di":	$messaggio = "no permitir ingresar reservas con menos de"; break;
