...
case "Inserisci una nuova password":  		$messaggio = "Ingresar una nueva contraseña"; break;
...
case "<div style=\"display: inline; color: red;\">non</div> inserita correttamente":	$messaggio = "<div style=\"display: inline; color: red;\">no</div> ingresada correctamente"; break;
...
case "Inserisci una nuova password per l'utente":	$messaggio = "Ingresa una nueva contraseña para el usuario"; break;
...
case "Si è sicuri di voler <b style=\"font-weight: normal; color: red;\">cancellare</b> l'utente":	$messaggio = "Está seguro de que quiere <b style=\"font-weight: normal; color: red;\">eliminar</b> el usuario"; break;
...
case "solo i privilegi":  			$messaggio = "solo los privilegios"; break;
