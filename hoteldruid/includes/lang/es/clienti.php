...
case "Si deve inserire il tipo di tariffa":  	$messaggio = "Debe poner el tipo de tarifa"; break;
case "tariffa":  				$messaggio = "tarifa"; break;
case "Non è stato ancora inserito il prezzo della":	$messaggio = "Aún no se ha puesto el precio de la"; break;
...
case "Inserisci i dati di un nuovo cliente":  	$messaggio = "Crear los datos de un nuevo cliente"; break;
...
case "Inserisci un nuovo cliente":  		$messaggio = "Crear un nuevo cliente"; break;
case "É necessario inserire il cognome del cliente":	$messaggio = "Es necesario poner el apellido del cliente"; break;
case "I dati del cliente":  			$messaggio = "Los datos del cliente"; break;
case "sono stati inseriti":  			$messaggio = "han sido creado"; break;
case "Inserisci o modifica i dati di un cliente":	$messaggio = "Crear o modificar los datos de un cliente"; break;
...
case "Inserisci i dati":  			$messaggio = "Guardar los datos"; break;
...
case "Non c'è nussun periodo delle regole 1 in cui sia consentito inserire prenotazioni per l'utente":	$messaggio = "No hay ningún período de las reglas 1 en el que esté consentido poner reservas para el usuario"; break;
...
case "Non si può inserire più di un costo aggiuntivo con percentuale sul prezzo totale per prenotazione":	$messaggio = "No se puede poner más de un coste añadido con porcentaje sobre el precio total por reserva"; break;
case "Non si puo inserire il costo aggiuntivo":	$messaggio = "No se puede poner el coste añadido"; break;
...
case "Non si possono inserire altri costi":  	$messaggio = "No se pueden poner más costes"; break;
case "in questo periodo, già":  		$messaggio = "en este periodo, ya"; break;
case "presenti":  				$messaggio = "presentes"; break;
case "Si deve inserire il numero delle persone per il costo aggiuntivo":	$messaggio = "Debe poner el número de personas para el coste añadido"; break;
...
case "la caparra è sbagliata":  		$messaggio = "el depósito es incorrecto"; break;
...
case "Si deve inserire almeno una persona che possa essere ospite principale":	$messaggio = "Debe poner por lo menos una persona que pueda ser huésped principal"; break;
...
case "Per questa tariffa si deve inserire un numero minimo di":	$messaggio = "Para esta tarifa debe poner por lo menos"; break;
