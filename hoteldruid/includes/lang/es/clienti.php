...
case "Si deve inserire il tipo di tariffa":  	$messaggio = "Debe ingresar el tipo de tarifa"; break;
case "tariffa":  				$messaggio = "tarifa"; break;
case "Non è stato ancora inserito il prezzo della":	$messaggio = "Aún no se ha ingresado el precio de la"; break;
...
case "Si devono fare i seguenti spostamenti nei periodi della <div style=\"display: inline; color: blue;\">regola di assegnazione 1</div>":	$messaggio = "Debe hacer los siguientes movimientos en los períodos de la <div style=\"display: inline; color: blue;\">regla de asignación 1</div>"; break;
...
case "Continua lo stesso":  			$messaggio = "Continuar de todos modos"; break;
case "Torna indietro":  			$messaggio = "Regresar"; break;
...
case "Inserisci i dati di un nuovo cliente":  	$messaggio = "Ingresar los datos de un nuevo cliente"; break;
case "Esistono i seguenti clienti con un cognome uguale o simile":	$messaggio = "Existen los siguientes clientes con apellido igual o similar"; break;
case "Esistono i seguenti clienti con un cognome e nome uguale o simile":	$messaggio = "Existen los siguientes clientes con apellido y nombre igual o similar"; break;
...
case "É necessario inserire il cognome del cliente":	$messaggio = "Es necesario ingresar el apellido del cliente"; break;
case "I dati del cliente":  			$messaggio = "Los datos del cliente"; break;
case "sono stati inseriti":  			$messaggio = "han sido ingresados"; break;
case "Inserisci o modifica i dati di un cliente":	$messaggio = "Ingresar o modificar los datos de un cliente"; break;
...
case "Inserisci i dati":  			$messaggio = "Ingresar los datos"; break;
...
case "Il numero di prenotazioni è sbagliato":	$messaggio = "El número de reservas es incorrecto"; break;
...
case "Il numero di persone è sbagliato":  	$messaggio = "El número de personas es incorrecto"; break;
case "I dati di un costo aggiuntivo sono errati":	$messaggio = "Los datos de un coste añadido son incorrectos"; break;
case "Non si può inserire più di un costo aggiuntivo con percentuale sul prezzo totale per prenotazione":	$messaggio = "No se puede ingresar más de un coste añadido con porcentaje sobre el precio total por reserva"; break;
...
case "Non si possono inserire altri costi":  	$messaggio = "No se pueden ingresar más costes"; break;
case "in questo periodo, già":  		$messaggio = "en este periodo, ya"; break;
case "presenti":  				$messaggio = "presentes"; break;
case "Si deve inserire il numero delle persone per il costo aggiuntivo":	$messaggio = "Debe ingresar el número de personas para el coste añadido"; break;
...
case "scade":  				$messaggio = "vence"; break;
...
case "Si deve inserire il numero delle persone per questa tariffa":	$messaggio = "Debe ingresar el número de personas para esta tarifa"; break;
...
case "le commissioni sono sbagliate":  		$messaggio = "las comisiones son incorrectas"; break;
...
case "Si deve inserire almeno una persona che possa essere ospite principale":	$messaggio = "Debe ingresar por lo menos una persona que pueda ser huésped principal"; break;
...
case "Per questa tariffa si deve inserire un numero minimo di":	$messaggio = "Para esta tarifa debe ingresar por lo menos"; break;
