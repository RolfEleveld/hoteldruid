...
case "da mostrare dopo le":  			$messaggio = "a mostrar después de las"; break;
...
case "Si è sicuri di voler eliminare la richiesta di prenotazione di":	$messaggio = "¿Está seguro de querer eliminar la solicitud de reserva de"; break;
case "non ancora inserita?":  			$messaggio = "todavía no ingresada?"; break;
case "Inserisci la prenotazione":  		$messaggio = "Ingresar la reserva"; break;
case "Visualizza il documento":  		$messaggio = "Ver el documento"; break;
case "di tipo":  				$messaggio = "tipo"; break;
case "Inserito":  				$messaggio = "Ingresado"; break;
case "Elimina tutti i messaggi":  		$messaggio = "Eliminar todos los mensajes"; break;
case "Si è sicuri di voler eliminare <div style=\"display: inline; color: red;\"><b>tutti i messaggi</b></div>":	$messaggio = "¿Está seguro de querer eliminar <div style=\"display: inline; color: red;\"><b>todos los mensajes</b></div>?"; break;
...
case "Controllare i dati immessi in":		$messaggio = "Verificar los datos ingresados en"; break;
...
case "Controlla disponibilità":  		$messaggio = "Verificar disponibilidad"; break;
