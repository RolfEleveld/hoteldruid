...
case "Non è possibile inserire la prenotazione senza":	$messaggio = "No es posible ingresar la reserva sin"; break;
case "dividerla":  				$messaggio = "dividirla"; break;
case "in":  					$messaggio = "en"; break;
case "Spezza la prenotazione in":  		$messaggio = "Divide la reserva en"; break;
case "Non si è potuto inserire la prenotazione a nome di":	$messaggio = "No se ha podido ingresar la reserva a nombre de"; break;
case "perchè il database è stato modificato nel frattempo":	$messaggio = "porque la base de datos ha cambiado mientras tanto"; break;
...
case "Commento":  				$messaggio = "Comentario"; break;
case "inserita":  				$messaggio = "ingresada"; break;
...
case "Nessuna nuova prenotazione è stata inserita":	$messaggio = "Ninguna nueva reserva ha sido ingresada"; break;
case "Transazione scaduta":  			$messaggio = "Transacción caducada"; break;
case "Non si è potuto inserire un costo aggiuntivo della prenotazione a nome di":	$messaggio = "No se ha podido ingresar un coste añadido de la reserva a nombre de"; break;
...
case "Le prenotazioni richieste nel messaggio sono già state inserite":	$messaggio = "Las reservas solicitadas en el mensaje ya han sido ingresadas"; break;
case "Attenzione":  				$messaggio = "Atención"; break;
case "il prezzo totale delle prenotazioni inserite":	$messaggio = "el precio total de las reservas ingresadas"; break;
case "il prezzo totale delle caparre inserite":	$messaggio = "el precio total de los depósitos ingresados"; break;
...
case "Modifica come gruppo le prenotazioni inserite":	$messaggio = "Modificar como grupo las reservas ingresadas"; break;
...
case "Il numero di persone inserite non include i bambini (vedere il commento per il numero di bambini)":	$messaggio = "El número de personas ingresado no incluye los niños (ver el comentario para el número de niños)"; break;
case "da":  					$messaggio = "desde"; break;
case "Si è dovuto diminuire il <b>numero di persone</b> per inserire la prenotazione":	$messaggio = "Hubo que disminuir el <b>número de personas</b> para ingresar la reserva"; break;
case "Prenotazione non inserita":  		$messaggio = "Reserva no ingresada"; break;
