...
case "<b style=\"color: red;\">ATTENZIONE</b>: premendo su <b>\"<i>Continua</i>\"</b>, prima di ripristinare i dati dal <i>file</i>, tutti i dati del <i>database attuale</i> verranno <b>cancellati</b>":	$messaggio = "<b style=\"color: red;\">ATENCIÓN</b>: al pulsar <b>\"<i>Continuar</i>\"</b>, antes de restaurar los datos desde el <i>archivo</i>, todos los datos de la <i>base de datos actual</i> serán <b>eliminados</b>"; break;
case "Inserisci i nuovi dati per la connessione al database":	$messaggio = "Ingrese los nuevos datos para la conexión a la base de datos"; break;
...
case "Numero della porta a cui collegarsi":	$messaggio = "Número del puerto al que conectarse"; break;
...
case "Vecchio database svuotato, per rimuoverlo del tutto procedere manualmente":	$messaggio = "Antigua base de datos vaciada, se puede eliminar completamente de forma manual"; break;
case "Database creato":  			$messaggio = "Base de datos creada"; break;
case "Non è stato possibile connettersi al nuovo database, controllare i dati per la connessione, i privilegi dell' utente o il nome del database":	$messaggio = "No ha sido posible conectarse a la nueva base de datos, verificar los datos de conexión, los privilegios del usuario o el nombre de la base de datos"; break;
case "Non è stato possibile creare il nuovo database, controllare i dati per la connessione, i privilegi dell' utente, il nome del database o se esiste già un database chiamato":	$messaggio = "No ha sido posible crear la nueva base de datos, verificar los datos de conexión, los privilegios del usuario, el nombre de la base de datos o si ya existe una base de datos llamada"; break;
...
case "Guarda il file":			$messaggio = "Ver el archivo"; break;
...
case " (i dati attuali verranno cancellati), utilizzando per la connessione al database:":	$messaggio = " (los datos actuales serán eliminados), utilizando para la conexión a la base de datos:"; break;
...
case "opzionale, utile per più installazioni di hoteldruid nello stesso database":	$messaggio = "opcional, útil para múltiples instalaciones de hoteldruid en la misma base de datos"; break;
case "Il prefisso del nome delle tabelle è sbagliato (accettate solo lettere minuscole, numeri e _ , primo carattere lettera)":	$messaggio = "El prefijo del nombre de las tablas es incorrecto (permitidas solo letras minúsculas, números y _ , primer carácter letra)"; break;
...
case "i documenti attuali verranno cancellati":	$messaggio = "los documentos actuales serán eliminados"; break;
...
case "Raggiunto il limite giornaliero di backup":	$messaggio = "Se ha alcanzado el límite de backups diarios"; break;
