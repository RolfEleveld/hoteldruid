...
case "El <b>nombre</b> verà cancellato":  	$messaggio = "El <b>nombre</b> será eliminado"; break;
case "La <b>data di nascita</b> verà cancellata":	$messaggio = "La <b>fecha de nacimiento</b> será eliminada"; break;
...
case "Cliente cancellato":  			$messaggio = "Cliente eliminado"; break;
case "Cancella il cliente":  			$messaggio = "Eliminar el cliente"; break;
case "Questo cliente non si può cancellare perché ancora associato a delle prenotazioni":	$messaggio = "Este cliente no se puede eliminar porque todavia tiene reservas asociadas"; break;
case "Annulla":  				$messaggio = "Cancelar"; break;
case "NO":  					$messaggio = "NO"; break;
case "Si è sicuri di voler <div style=\"display: inline; color: red;\">cancellare</div> il cliente":	$messaggio = "Está seguro de querer <div style=\"display: inline; color: red;\">eliminar</div> el cliente"; break;
...
case "La <b>región de residencia</b> verà cancellata":  	$messaggio = "La <b>región de residencia</b> será eliminada"; break;
case "Il <b>documento</b> verà cancellato":  	$messaggio = "El <b>documento</b> será eliminado"; break;
...
case "password errata":  			$messaggio = "contraseña incorrecta"; break;
case "i dati della carta di credito sono stati cancellati":	$messaggio = "los datos de la tarjeta de crédito han sido eliminados"; break;
case "il numero di carta di credito è <span class=\"colred\">sbagliato</span>":	$messaggio = "el número de la tarjeta de crédito está <span class=\"colred\">incorrecto</span>"; break;
...
case "cancella questa carta di credito":  	$messaggio = "eliminar esta tarjeta de crédito"; break;
...
case "Cancellalo ora":  			$messaggio = "Eliminarlo ahora"; break;
