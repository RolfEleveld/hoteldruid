...
case "Massimo numero di occupanti":  		$messaggio = "Máximo número de personas que puede acomodar"; break;
case "Aggiungi stanza":				$messaggio = "Agregar habitación"; break;
case "Rimuovi stanza":				$messaggio = "Quitar habitación"; break;
case "Guardar configuración de habitaciones":	$messaggio = "Guardar configuración de habitaciones"; break;
case "Stanza":				$messaggio = "Habitación"; break;
case "Numero stanza":			$messaggio = "Número de habitación"; break;
case "Massimo numero di occupanti":		$messaggio = "Máximo número de ocupantes"; break;
case "Numero piano":				$messaggio = "Número de piso"; break;
case "Numero casa":				$messaggio = "Número de casa"; break;
case "Priorità":				$messaggio = "Prioridad"; break;
case "Database non trovato":			$messaggio = "Base de datos no encontrada"; break;
case "Il database non esiste o non è accessibile":	$messaggio = "La base de datos no existe o no está accesible"; break;
case "Utilizzare il modulo sottostante per creare un nuovo database":	$messaggio = "Por favor, utilice el formulario a continuación para crear una nueva base de datos"; break;
case "Salva configurazione stanze":		$messaggio = "Guardar configuración de habitaciones"; break;
case "Habitación":				$messaggio = "Habitación"; break;
