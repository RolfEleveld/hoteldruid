...
case "Nome utente o password <div style=\"display: inline; color: red;\">errati</div>":	$messaggio = "Nombre de usuario o contraseña <div style=\"display: inline; color: red;\">incorrectos</div>"; break;
case "Numero eccesivo di login <div style=\"display: inline; color: red;\">errati</div> negli ultimi":	$messaggio = "Número excesivo de logins <div style=\"display: inline; color: red;\">incorrectos</div> en los últimos"; break;
case "minuti":  				$messaggio = "minutos"; break;
case "Dopo un login <div style=\"display: inline; color: red;\">errato</div> si devono attendere":	$messaggio = "Después de un login <div style=\"display: inline; color: red;\">incorrecto</div> hay que esperar"; break;
case "secondi":  				$messaggio = "segundos"; break;
case "Il database deve essere aggiornato":  	$messaggio = "La base de datos debe ser actualizada"; break;
...
case "Numero eccesivo di sessioni <span style=\"color: red;\">errate</span> originate dal tuo indirizzo IP negli ultimi":	$messaggio = "Número excesivo de sesiones <span style=\"color: red;\">incorrectas</span> desde tu dirección IP en los últimos"; break;
