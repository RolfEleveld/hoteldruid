...
case "Si potrebbe inserire la prenotazione dividendola in":	$messaggio = "Se podría ingresar la reserva dividiéndola en"; break;
...
case "Ricontrolla":  				$messaggio = "Volver a verificar"; break;
...
case "Non c'è nussun periodo delle regole 1 in cui sia consentito inserire prenotazioni per l'utente":	$messaggio = "No hay ningún período de las reglas 1 en el que esté consentido ingresar reservas para el usuario"; break;
...
case "Mostra le tariffe non disponibili":  	$messaggio = "Mostrar tarifas no disponibles"; break;
case "Scegliere le settimane in cui applicare il costo aggiuntivo":	$messaggio = "Escoger las semanas en las que aplicar el coste añadido"; break;
...
case "non disponibile":  			$messaggio = "no disponible"; break;
