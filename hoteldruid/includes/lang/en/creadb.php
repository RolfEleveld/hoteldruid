...
case "Aggiungi stanza":				$messaggio = "Add room"; break;
case "Rimuovi stanza":				$messaggio = "Remove room"; break;
case "Guardar configuración de habitaciones":	$messaggio = "Save room settings"; break;
case "Stanza":				$messaggio = "Room"; break;
case "Numero stanza":				$messaggio = "Room number"; break;
case "Massimo numero di occupanti":		$messaggio = "Maximum number of occupants"; break;
case "Numero piano":				$messaggio = "Floor number"; break;
case "Numero casa":				$messaggio = "House number"; break;
case "Priorità":				$messaggio = "Priority"; break;
case "Database non trovato":			$messaggio = "Database not found"; break;
case "Il database non esiste o non è accessibile":	$messaggio = "The database does not exist or is not accessible"; break;
case "Utilizzare il modulo sottostante per creare un nuovo database":	$messaggio = "Please use the form below to create a new database"; break;
case "Salva configurazione stanze":		$messaggio = "Save room settings"; break;
