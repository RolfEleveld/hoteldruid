...
case "Eccezione alla regola 2 per periodo limitato": $messaggio = "Exception to rule 2 for limited period"; break;
case "Tariffa": $messaggio = "Rate"; break;
case "mostra tabella": $messaggio = "show table"; break;
case "nascondi tabella": $messaggio = "hide table"; break;
case "variabile": $messaggio = "variable"; break;
case "da assegnare per ogni prenotazione": $messaggio = "to be assigned for each reservation"; break;
case "Inserisci o modifica l'eccezione alla regola": $messaggio = "Insert or modify the exception to rule"; break;
case "Numero di giorni": $messaggio = "Number of days"; break;
case "dall'inizio o dalla fine del periodo": $messaggio = "from the beginning or the end of the period"; break;
case "Azione": $messaggio = "Action"; break;
case "Periodo dal": $messaggio = "Period from"; break;
case "Motivazione": $messaggio = "Motivation"; break;
case "Assegna a utente": $messaggio = "Assign to user"; break;
case "sceglie questa tariffa, fai risultare come se l'utente selezionato avesse inserito la prenotazione e l'eventuale cliente": $messaggio = "chooses this rate, show as if the selected user had inserted the reservation and the eventual client"; break;
case "Numero di persone": $messaggio = "Number of people"; break;
case "Minimo persone": $messaggio = "Minimum people"; break;
case "Inserimento rapido costo aggiuntivo": $messaggio = "Quick insert additional cost"; break;
