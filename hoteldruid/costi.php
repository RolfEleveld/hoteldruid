...
$nome_costo = htmlspecialchars(fixstr($nome_costo),ENT_COMPAT);
...
$metodo_pagamento = htmlspecialchars(fixstr($metodo_pagamento),ENT_COMPAT);
...
if ($priv_persona_ins_costi != "c") $persona_costo = "";
