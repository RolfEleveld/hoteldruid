...
<div style=\"padding-top: 6px;\"><em>".mex("Nota",$pag)."</em>: ".mex("aggiungendo",$pag)." <em>&del=1</em> ".mex("alla URL verranno cercate le prenotazioni cancellate, anche nelle URL successive",$pag).".</div>
