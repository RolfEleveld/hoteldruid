...
";
include(C_DATI_PATH."/lingua.php");
if (empty($lingua[$id_utente_mod]) or !is_dir("./includes/lang/".$lingua[$id_utente_mod])) $lingua_mex = "ita";
else $lingua_mex = $lingua[$id_utente_mod];
...
";
if (empty($lingua[$id_utente]) or !is_dir("./includes/lang/".$lingua[$id_utente])) $lingua_mex = "ita";
else $lingua_mex = $lingua[$id_utente];
$linee[$num_lin] = "
\";
