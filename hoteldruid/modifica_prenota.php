...
$n_prezzo_costo_agg[$num_reg] = (double) calcola_prezzo_totale_costo($dati_ca,$num_costo,$inizioperiodo,$fineperiodo,$n_settimane_costo[$num_reg],$n_moltiplica_costo[$num_reg],$costo_tariffa,$tariffesettimanali,1,$caparra,$numpersone,$dati_cat_pers,fixset(${"catpers_ca$numca"}));
...
$d_costo_tariffa_vett[$id_prenota] = (double) fixset($d_tariffa[1]);
